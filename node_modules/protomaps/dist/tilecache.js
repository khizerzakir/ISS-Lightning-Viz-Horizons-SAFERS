...
function parseTile(buffer, tileSize) {
    ...
    for (let [key, value] of Object.entries(v.layers)) {
        ...
        for (let i = 0; i < layer.length; i++) {
            let loaded = loadGeomAndBbox(layer.feature(i)._pbf, layer.feature(i)._geometry, tileSize / layer.extent);
            let numVertices = 0;
...
export class PmtilesSource {
    ...
    get(c, tileSize) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let result = yield this.p.getZxy(c.z, c.x, c.y, signal);
            if (result) {
...
export class TileCache {
    ...
    queryFeatures(lng, lat, zoom, brushSize) {
        ...
        if (entry) {
            const center = new Point((on_zoom.x - tile_x) * this.tileSize, (on_zoom.y - tile_y) * this.tileSize);
