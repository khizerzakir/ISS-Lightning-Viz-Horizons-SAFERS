import { CenteredTextSymbolizer, CircleSymbolizer, exp, LineLabelSymbolizer, LineSymbolizer, PolygonSymbolizer, } from "./../symbolizer";
...
export function numberFn(obj) {
    if (obj.base && obj.stops) {
        ...
        let prop = obj[1][1];
        return (z, f) => {
            let val = f === null || f === void 0 ? void 0 : f.props[prop];
